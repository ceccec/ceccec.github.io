...
export type { PageGapsKind, PaperFormulaPart, QuantumProjection, ScientificPageMeaning, ScientificPaperBody } from '../../src/quantum/apps'
export { paperFormulaParts } from '../../src/quantum/apps'
...
export { PUBLICATION_CREDIT, pageCitation, cursorReferralFundsAiNeeds, domainProofPageBySlug, domainProofPagePaths, domainProofPageRows } from '../../src/research'
