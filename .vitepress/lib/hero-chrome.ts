...
export function heroChromeForPath(path: string, cssWidth = 1024, mode: HeroChromeMode = 'light'): Record<string, string> {
...
export function applyHeroChromeVars(path: string, cssWidth = 1024, mode?: HeroChromeMode): void {
...
export function heroChromeStyleBlock(path: string, matrix = buildMatrix(), cssWidth = 1024, mode: HeroChromeMode = 'light'): string {
...
export function heroChromeStyleBlocks(path: string, matrix = buildMatrix(), cssWidth = 1024): string {
