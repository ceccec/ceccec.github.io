...
// Bulgarian stays at /bg/. The root Glagolitic pages are generated by scripts/generate-glagolitic.mjs
// (the /en/ pages autotranslated). Root locale = Glagolitic: transliterate the labels, keep the / links.
...
export default defineConfig({
  ...
  // Content lives under site/ (the page tree); the repo root holds only config, tooling and src.
  // .vitepress, src/, scripts/ and packages/ stay at the root — srcDir points VitePress at site/.
  srcDir: 'site',
  cleanUrls: true,
