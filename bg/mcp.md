---
outline: deep
description: "Порталът Двоен тор като MCP инструментален слой: всяка концептуална команда е инструмент за езикови модели, публикуван на /mcp.json."
head:
  - - meta
    - property: og:title
      content: "MCP инструментален слой | Двоен тор"
  - - meta
