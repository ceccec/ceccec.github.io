...
export const PRIOR_ART_SEARCHED: readonly {
  ...
  { theorem: 'units of ℤ[i] are exactly {±1,±i}',
    ...
    when: '2026-09-06',
    found: 'the units of ℤ[i] are exactly ±1 and ±i, characterised by N(ε) = a² + b² = 1. Classical.' },
  { theorem: 'ℤ[i] is a Euclidean domain',
    searched: 'Gaussian integers form a Euclidean domain division algorithm norm',
    when: '2026-09-06',
    found: 'ℤ[i] is a Euclidean domain under the norm, hence a UFD — the standard result behind unique factorisation of Gaussian integers.' },
  { theorem: 'Eisenstein norm a²−ab+b² is multiplicative',
    searched: 'Eisenstein integers norm a^2 - ab + b^2 multiplicative valuation',
    when: '2026-09-06',
    found: 'for a + bω the norm is N = a² − ab + b², and it is a valuation on ℤ[ω] — multiplicativity is exactly what makes it one.' },
  { theorem: 'ℤ[ω] is a Euclidean domain',
    ...
    when: '2026-09-06',
    found: 'ℤ[ω] is a Euclidean domain under that norm, hence a UFD; its unit group is the six sixth-roots of unity {±1, ±ω, ±ω²} — larger than ℤ[i]’s four.' },
  { theorem: 'Pell’s equation x²−Dy²=1 is solvable',
    ...
    when: '2026-09-06',
    found: 'Lagrange gave the first rigorous proof of solvability in 1768 (published 1773): for every non-square D > 0 the continued-fraction convergents of √D yield a solution, and there are infinitely many.' },
  { theorem: 'Lucas–Lehmer test for Mersenne primes',
    searched: 'Lucas 1878 Lehmer 1930 Mersenne primality test s_{p-1} ≡ 0 mod M_p',
    when: '2026-09-06',
    found: 'THE EPONYM SPLITS THE WORK. Lucas proposed two tests for Mersenne primality in 1878 but neither came with a complete proof; D. H. Lehmer stated AND PROVED the necessary-and-sufficient condition in 1930, as part of his PhD thesis. Both names are earned, for different things.' },
  { theorem: 'order-(n−1) primality test',
    ...
    when: '2026-09-06',
    found: 'Lucas (1876): if a^(n−1) ≡ 1 (mod n) and a^((n−1)/p) ≢ 1 for every prime p | n−1, then n is prime — the converse of Fermat turned into a sufficient condition by an order argument.' },
  { theorem: 'Stein’s binary gcd is equivalent to Euclid’s',
    ...
    when: '2026-09-06',
    found: 'published in its modern form by the physicist and programmer Josef Stein in 1967; it replaces division with shifts, comparisons and subtraction, computing the same gcd as Euclid’s algorithm.' },
