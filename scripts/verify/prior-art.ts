...
export const PRIOR_ART_POOL: readonly {
  ...
  { theorem: 'Frobenius number of (6,9,20) is 43', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — the numerical-semigroup Frobenius or coin problem — so a search is unambiguously well posed' },
  ...
  { theorem: 'Pick’s theorem Area = I + B/2 − 1', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — lattice-polygon geometry, Pick 1899 — so a search is unambiguously well posed' },
  { theorem: 'Catalan conjecture 8 and 9 to 10⁶', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — the Catalan conjecture, proved by Mihailescu 2002 — so a search is unambiguously well posed' },
  { theorem: 'Lucas theorem for binomials mod p', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — binomial coefficients modulo a prime, Lucas 1878 — so a search is unambiguously well posed' },
  { theorem: 'Viviani constant distance sum', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — Euclidean geometry, Viviani 1600s — so a search is unambiguously well posed' },
  { theorem: 'Matrix-Tree theorem (Kirchhoff)', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — spanning-tree enumeration, Kirchhoff 1847 — so a search is unambiguously well posed' },
  { theorem: '561 is the smallest Carmichael number', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — number theory, Carmichael numbers — so a search is unambiguously well posed' },
  { theorem: 'Catalan bijection Dyck = trees = formula', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — enumerative combinatorics, the standard Catalan bijections — so a search is unambiguously well posed' },
  { theorem: 'De Bruijn sequence exact-window', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — combinatorics on words, De Bruijn sequences — so a search is unambiguously well posed' },
  { theorem: 'hockey-stick identity', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — binomial-coefficient identities — so a search is unambiguously well posed' },
  { theorem: 'Bézout identity via extended Euclid', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — elementary number theory, the extended Euclidean algorithm — so a search is unambiguously well posed' },
  { theorem: 'Euclid lemma p | ab ⇒ p | a or p | b', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — elementary number theory, Euclid lemma — so a search is unambiguously well posed' },
  { theorem: 'Legendre prime-power formula for n!', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — the Legendre or de Polignac formula for the exponent of a prime in a factorial — so a search is unambiguously well posed' },
  { theorem: 'Kummer carry theorem', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — Kummer theorem on carries and binomial valuations — so a search is unambiguously well posed' },
  ...
  { theorem: 'Legendre three-square theorem', pool: 'bounded',
    why: 'a NAMED result with a standard attribution — number theory, the Legendre three-square theorem — so a search is unambiguously well posed' },
