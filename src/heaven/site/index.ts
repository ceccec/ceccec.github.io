...
export { quantumSitemap, professionals, siteConfig, computedWebManifest, staticPages, crawlerKnowledge, monographTemplate, monographAsScientificPaper, theoremScienceLens, theoremScienceVisible } from '../../wind/site'
