...
export { quantumSitemap, professionals, siteConfig, computedWebManifest, staticPages, crawlerKnowledge, monographTemplate, monographAsScientificPaper } from '../../site'
