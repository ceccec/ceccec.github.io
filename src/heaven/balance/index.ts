...
export function iChingDomainMap(matrix: MindMatrix = buildMatrix()) {
  ...
  const domains = [
    ...
    { bits: 0b010, module: 'src/quantum/lake/voice', dual: 'src/water/double', slugs: ['voice', 'explore', 'commands', 'console', 'mcp', 'show', 'quantum-tools', 'quantum-trading-hub'], summary: 'Plain language, speech, UX, command flow — the communicative layer.' },
    { bits: 0b011, module: 'src/quantum/lake/spirit', dual: 'src/iching', slugs: ['spirit', 'school', 'academy', 'governance', 'society-merkaba'], summary: 'Chakras, dualities, dimensions, joyous learning and fair life.' },
