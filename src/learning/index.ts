...
import * as __ns_up_language from '../wind/language'
...
import type { AgentEducation, AgentLesson, ConceptSiteSection, McpTool, McpToolManifest, MindMatrix, StaticPage, SchoolCurriculum, SchoolLesson } from '../wind/types'
...
import { monographSliceFromRoute, ROUTE_ALIASES } from '../wind/routes/automount'
import { homeHero, isServedRoute, localePath, pickLocale, displayText, quantumSitemap, staticPages, theoremScienceLens, theoremScienceVisible, siteDomainRegistry, applyDomainRegistrySidebars, dryCleanVitepressNavSidebarsFromDomainRegistry, folderMigrationDedupWaves, type LocaleName } from '../wind/site'
...
import { completeCorpus, theoremRosettaSidebar, theRosettaReconfiguresVitepress } from '../wind/routes/corpus'
...
import { proofAcknowledgmentFormatSaved } from '../wind/site'
import { quantumCoordinateNav } from '../fire/features'
import { openGraph } from '../quantum/icons'
import { navigationAroundHero } from '../wind/ui'
...
import { anyUuidHeroContentFractal, displayHeroCardThumb, heroGraphStatisticsEnrichFusion, holographicFractalArchitecture, merkabaFoldsSpeechAnalogDialectsEntangle } from '../wind/ui'
