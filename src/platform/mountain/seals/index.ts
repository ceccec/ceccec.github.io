...
import { buildMatrix, entropy, proofReport } from '../../../research/heaven/compute'
...
import { cloudflareBindings } from '../../../research/heaven/core'
import * as __ns_heaven_site from '../../../research/heaven/site'
import { threeWordWaves, sciencePortalParts, siteNavigation } from '../../../learning'
import { refactorLinearToTrinities } from '../../../research/heaven/essence'
import { endlessFusion, allFormsAreTenDimensionalOrPurged } from './wind/fusion'
import { iChingDomainMap } from '../../../research/heaven/balance'
...
import { quantumAppsStore, quantumCoordinateNav, quantumFirewallProxyWorker, quantumSynthesis, quantumThreat } from '../../../research/fire/features'
import { multidimensional } from '../../../quantum/icons'
import { livingTorus, piTrainDiamonds, selfBuild, streamSelfComplete } from '../../../research/fire/diamonds'
...
import { digitFolders, digitFoldersAreTheApi, folder64SealsProductionElseDevelopment, folderLaw } from '../../../research/earth/architecture'
import {
  coordinatedWaves,
  ...
  ogInOgWaves,
  quantumChessGame,
  wavesWorkingInTrinitiesTrinitiesAreFound } from '../../../applications/thunder/waves'
import {
...
import { oneCommandDecodeComputable } from '../../../applications/thunder/decode'
...
import { revolutionaryEfficiencyNotPhysics } from '../../../applications/thunder/verify'
...
import {
  ...
  tradingTrainHonestyGate, liveWinTrainingGate, strategiesChallengeInChat } from '../../../applications/thunder/trading'
import { namingEntropy, shouldSpawnSubagent } from './water/stack'
import { emergentDimensions, modelSeal } from '../../../research/heaven/balance'
...
export function proofRegistry(matrix: MindMatrix = buildMatrix()) {
  ...
  const entries = [
    ...
    { slug: 'readme-svg-trinity-mind', title: 'README SVG gaps filled by trinity mind — intentional open WebGL/plasma/SMIL', proof: __ns_heaven_site.readmeSvgGapsFilledByTrinityMind(matrix) },
    ...
    { slug: 'theorem-particle-collision', title: 'Theorem particle collision inverse×reverse', proof: theoremParticleCollisionInverseReverse(matrix) },
