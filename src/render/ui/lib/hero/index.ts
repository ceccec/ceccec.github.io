// The hero's logic lives in src/quantum — all of it, folded into the quantum namespace as render dimensions
// (seed, dimensions, geometry, fractal, flower, calendars, architecture, bursts) beside the mind/cache/library
