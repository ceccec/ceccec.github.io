...
const items = [
  { label: `fuse · ${d.pair.fuse}`, detail: d.pair.forward },
  { label: `reveal · ${d.pair.reveal}`, detail: d.pair.reverse },
  { label: `${d.componentCount} components · iChing root`, detail: d.ichingRoot },
