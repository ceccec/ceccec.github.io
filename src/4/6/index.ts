...
export const THEOREM_ATOM_SEED: readonly { theorem: string; states: string; provedBy: string; home: string }[] = [
    ...
    { theorem: 'symbols remaining to quantumise', states: 'Continue I Ching and yin-yang: inventory sealed|partial|missing at call time; quantumise remaining geometry as computed SVG (bagua · vesica · metatron · sri-yantra seed · tree · platonic · omAumSvg←PHI∧TAU · elderFutharkGridSvg←runeCoordinate · alchemySigilsSvg←sacredGeometry); compose FoL/Fruit/merkaba via readme/svg-trinity; partial Glagolitic SMIL · torus-knots named; wetStatic=false; clay=0 · physicalFtl=0 · qpuRequired=false.', provedBy: 'symbolsRemainingToQuantumise', home: 'src/heaven/site' },
