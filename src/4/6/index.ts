...
export const THEOREM_ATOM_SEED: readonly { theorem: string; states: string; provedBy: string; home: string }[] = [
    ...
    { theorem: 'readme svg gaps filled by trinity mind', states: 'ONLY trinity mind may compute the README SVG: fillable gaps (dual ω/−ω hero · theorem glyphs · trinity emit tag · icon movie palette · icon dual SMIL · generators) close via heaven·mind·thunder composing counterRotatingRosetta · directionalTrinity · theTrinityOfMinds · merkaba/bothEarths · fractalClock · computedIconSvg; intentional open remain WebGL on GitHub · plasma completeness · SMIL client variance; clay=0 · physicalFtl=0 · qpuRequired=false.', provedBy: 'readmeSvgGapsFilledByTrinityMind', home: 'src/heaven/site' },
