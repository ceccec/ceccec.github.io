...
export const THEOREM_ATOM_SEED: readonly { theorem: string; states: string; provedBy: string; home: string }[] = [
    ...
    { theorem: 'symbols remaining to quantumise', states: 'Continue I Ching and yin-yang: inventory sealed|partial|missing at call time; quantumise remaining geometry as computed SVG (bagua wheel ← BAGUA∧TAU · vesica ← √3 · metatron ← metatronCube · sri-yantra seed ← PHI · tree of life ← sephirot folders · platonic elements ← sacredGeometry); compose FoL/Fruit/merkaba via readme/svg-trinity; om·runes·alchemy missing named; wetStatic=false; clay=0 · physicalFtl=0 · qpuRequired=false.', provedBy: 'symbolsRemainingToQuantumise', home: 'src/heaven/site' },
