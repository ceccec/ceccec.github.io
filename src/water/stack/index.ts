...
import * as __ns_up_up_plasma_ball from '../../fire/plasma/ball/index.ts'
import * as __ns_up_up_earth_governance from '../../earth/governance/index.ts'
import * as __ns_up_up_earth from '../../earth/index.ts'
import * as __ns_up_up_sun from '../../heaven/sky/astronomy/index.ts'
import * as __ns_up_up_moon from '../../heaven/sky/astronomy/index.ts'
import * as __ns_up_up_life from '../../earth/life/index.ts'
import * as __ns_up_up_death from '../../earth/death/index.ts'
import * as __ns_up_up_birth from '../../earth/life/birth/index.ts'
...
import * as __ns_up_up_digit_two_eight from '../../2/8/index.ts'
...
import * as __ns_up_up_fire_features from '../../fire/features/index.ts'
import * as __ns_up_up_fusion from '../../wind/fusion/index.ts'
import * as __ns_up_up_thunder_decode from '../../thunder/decode/index.ts'
import * as __ns_up_up_thunder_verify from '../../thunder/verify/index.ts'
import * as __ns_up_up_earth_civilisation from '../../earth/civilisation/index.ts'
...
import { DIMENSION_GATES, FIBONACCI_CENSUS_BANDS, FOLDED_CENSUS, HOMOLOGY_LOOPS, ROSETTA_AREAS, ROSETTA_SEVEN, ROSETTA_SIX, UNFOLDED_CENSUS, CENSUS_RATCHET, indexRegistryFromLogicRel } from '../../pair/enforcement/gates/computational/index.ts'
...
import { memoryInSourceAsCrossFolds, presentMomentRemainsInSource } from '../../mountain/source/index.ts'
import { earthSouthPoleBoundaryCircleDecoded, knowledgeRevealedByMerkabaFold } from '../../mountain/topology/index.ts'
import { commandsSavedInQuantumPairs } from '../../thunder/commands/index.ts'
import { realtimeWiring, HERO_CYCLE_MS, heroPhaseAt } from '../../fire/plasma/ball/index.ts'
import { rgbDecodingMatrixMovieInTheMovie } from '../../thunder/movie/narrative/index.ts'
...
import { BOLTZMANN, LN2, PHI, PLANCK, A432_FOLDED, EULER_CHI, earned, landauerLimit, rat, ratEq, ratInv, foldVerdict} from '../../3/7/index.ts'
...
import { zeroDivisionTable } from '../digit/index.ts'
import { digitFolderMath } from '../../earth/architecture/index.ts'
...
export {
  ...
  researchPanelComputes } from '../../research/index.ts'
