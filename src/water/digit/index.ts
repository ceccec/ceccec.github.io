...
export { ROSETTA_COMPUTATION_TYPES, ROSETTA_RAYS, ROSETTA_RAY_HUBS, ROSETTA_RAY_HUB_SLUGS, rosettaRayHub, type RosettaComputationType, type RosettaRay, type RosettaRayHub, type RosettaRayHubSlug } from '../../3/7' // hub IA + rosetta tables hosted in the zero-import leaf to break the SSR TDZ; public path unchanged
...
export function piTrainExportImportFusion(matrix: MindMatrix = buildMatrix()) {
  ...
  const facets = [
    ...
    { facet: 'wave-10 exports homed at src/6/4 recompute at call', on: HUBBLE_CONSTANT_LOCAL > 70 && PROTON_GYROMAGNETIC > 4e7 && ZHL16_HE_HALFTIMES.length === 16 && cantorDiagonal([[1, 0], [0, 1]]).join(',') === '0,0' && resonantAmplitude(100, 100, 10) > 9 && humanEase(0.5) === 0.5 && frequencyOf(0.5) > 5e8 && quantumZeno(100) > 0.99 && casimirEnergyPerArea(1e-6) < 0 && congruence([1, 2, 3], [1, 2, 3]) === 1 },
    ...
    { facet: 'wave-12 exports homed at stations recompute at call', on: slip(100, 90) === 0.1 && phase(Math.PI / 2)[6] === 0 && inductionStep(40, { wSync: 100, k: 10, load: 0 }) > 40 && inductionEvolve(40, { wSync: 100, k: 10, load: 0 }, 3).length === 4 },
