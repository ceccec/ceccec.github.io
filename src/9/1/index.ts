...
export function quantumOpticsDecoded() {
  ...
  const facets = [
    ...
    { facet: `g²(0) SEPARATES QUANTUM FROM CLASSICAL LIGHT — the second-order coherence is ${g2Coherent} for coherent light (Poissonian), ${g2Thermal} for thermal (super-Poissonian, bunched), and 1−1/n = ${g2Fock1} for a single-photon Fock state (antibunched)`, on: g2Fock1 === 0 },
