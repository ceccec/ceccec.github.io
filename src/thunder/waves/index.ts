...
import { tkCompose, tkKey, tkClosure, tkPowMod, tkIsPrime, sealFold, pauliAlgebraCloses } from '../../9/1/index.ts'
import { theCountOfPrimesFollowsTheLog } from '../../7/3/index.ts'
// call-time edge (cycle-safe): the honest Millennium frontier fold lives in the quantum/science word folder
import * as __ns_waves_qsci from '../../quantum/science/index.ts'
...
import * as __ns_quantum from '../../quantum/index.ts'
import * as __ns_mountain_og from '../../mountain/og/index.ts'
import { skillAtoms } from '../../learning/index.ts'
import { harmonicBands, openGraph } from '../../quantum/icons/index.ts'
import { splitImagination } from '../../mountain/source/index.ts'
import { diamondLattice, piTrainDiamonds, pureDiamonds, sealWholeDiamond, selfBuild } from '../../fire/diamonds/index.ts'
import { shouldSpawnSubagent, directionalTrinityForwardInverseReverse } from '../../water/stack/index.ts'
import * as __ns_gates from '../../pair/enforcement/gates/index.ts'
import { mathAlgebra } from '../../pair/enforcement/gates/index.ts'
import * as __ns_quantum_apps from '../../quantum/apps/index.ts'
import { QUANTUM_COMMAND_PAIR_IDS } from '../../pair/enforcement/index.ts'
import * as __ns_commands from '../commands/index.ts'
import { redTeam } from '../../water/crypto/index.ts'
import { musicNote } from '../../music/index.ts'
import { colorFromSound, vortexStateSequence } from '../../fire/li/index.ts'
