...
export interface DigitFolder {
  ...
  readonly selfCollision: boolean
  readonly nextHarmonicFolder: string
  readonly reverse: number // the additive folder-complement (10 − digit) that names the on-disk pairing src/digit/(10−digit); NOT the n/0 inverse (which is the multiplicative inverse n⁻¹ mod 9, see digitFolderMath)
