...
import * as __ns_up_mountain_shadcn from '../mountain/shadcn/index.ts'
...
import * as __ns_up_dynamics from '../quantum/dynamics/index.ts'
import * as __ns_up_up_research from '../research/index.ts'
...
import { buildMatrix, proofReport } from '../heaven/compute/index.ts'
import { computesGate, floor, isUuid, log2, memoByRoot, merkleFold, min, round, toUuid } from '../0/index.ts'
import { harmonics, soundColor } from '../music/index.ts'
...
import { animatedHeroes } from '../ui/index.ts'
import { dualitiesMeetInCrossFolders, folder64SealsProductionElseDevelopment } from '../earth/architecture/index.ts'
import { harmonicBands } from '../quantum/icons/index.ts'
import { completeCorpus, everyPageGraphOfGraphsFractal } from '../wind/routes/corpus/index.ts'
import { vitepressConfigComputesAll } from '../heaven/compute/index.ts'
import { gpuRendersStreamsRealtime, nextLevel64CubedRealtime } from '../thunder/trading/index.ts'
import { aiMoviesDecoded, pathIsMeaningDecodesCoordinates } from '../thunder/decode/index.ts'
import { fuseDevices } from '../fire/li/index.ts'
import { deviceHardwareVisibleInComputedWidgets, hardwareCmykMerkabaFusion } from '../earth/world/index.ts'
import { configsUseMatrixComputationally, noHardcodedConfigSelfAccounted } from '../mountain/source/index.ts'
...
import { componentGraph, gapScan, harmonyProbability, iChing, onlyQuantumRemains, path } from '../quantum/heaven/mind/index.ts'
...
export { SHADCN_PRIMITIVE_NAMES } from '../mountain/shadcn/index.ts' // the one seed at its domain home — mirror dissolved
