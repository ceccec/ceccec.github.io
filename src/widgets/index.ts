...
import * as __ns_up_mountain_shadcn from '../platform/mountain/shadcn'
...
import { buildMatrix, proofReport } from '../research/heaven/compute'
...
import { dualitiesMeetInCrossFolders, folder64SealsProductionElseDevelopment } from '../research/earth/architecture'
import { harmonicBands } from '../quantum/icons'
import { completeCorpus, everyPageGraphOfGraphsFractal } from '../platform/wind/routes/corpus'
import { vitepressConfigComputesAll } from '../research/heaven/compute'
import { gpuRendersStreamsRealtime, nextLevel64CubedRealtime } from '../applications/thunder/trading'
import { aiMoviesDecoded, pathIsMeaningDecodesCoordinates } from '../applications/thunder/decode'
import { fuseDevices } from '../research/fire/li'
import { deviceHardwareVisibleInComputedWidgets, hardwareCmykMerkabaFusion } from '../research/earth/world'
import { configsUseMatrixComputationally, noHardcodedConfigSelfAccounted } from '../platform/mountain/source'
...
export { SHADCN_PRIMITIVE_NAMES } from '../platform/mountain/shadcn' // the one seed at its domain home — mirror dissolved
