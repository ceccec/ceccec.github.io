...
import { min, round } from '../0/index.ts'
...
<template>
  <UiCard id="quantum-widgets-gallery" class="quantum-widgets" data-logic="src/widgets/index.ts" data-target="src/widgets/index.ts#quantumWidgetsComputes" data-topic="quantum-widgets">
