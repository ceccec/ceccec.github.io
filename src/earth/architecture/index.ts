...
export function folderLaw() {
  return {
    ...
    roots: ['.', 'en', 'bg'], // the trunk: the Glagolitic root (default), the Latin / and the Cyrillic /bg/ locale roots
