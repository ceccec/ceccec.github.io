...
import * as __ns_up_death from '../../death/index.ts'
import { phase } from '../../../6/4/index.ts'
import type { MindMatrix } from '../../../types/index.ts'
import { buildMatrix } from '../../../heaven/compute/index.ts'
import { computesGate, isUuid, memoByRoot, merge, merkleFold, toUuid } from '../../../0/index.ts'
import { createByDefault } from '../../../heaven/laws/index.ts'
import { genesis } from '../../nature/index.ts'
import { creationWave } from '../../../thunder/waves/index.ts'
import { formsEmergeInMovieOfLife } from '../../../thunder/movie/movielib/index.ts'
import { kidsDefineEducation } from '../../../fire/li/index.ts'
import { originOfLifeAbiogenesisDecoded } from '../index.ts'
...
export const BIRTH_LIFE_DEATH_TRIAD = [
  { phase: 'birth', fuse: 'genesis origin creation emergence — seed unfolds to forms', mount: 'src/earth/life/birth' },
