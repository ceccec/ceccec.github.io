...
export function proofRegistry(matrix: MindMatrix = buildMatrix()) {
  ...
  const entries = [
    ...
    { slug: 'clay-tool-from-beyond-external', title: 'Clay tools from beyond — 5-level rigor gradient · required tool external in 7/7 · algebra excluded where named (P vs NP) · claySolvedByThisFold = 0', proof: clayToolFromBeyondLivesInAnExternalStructureNeverThisCorpusAlgebra(matrix) },
