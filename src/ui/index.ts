...
import * as __ns_up_up_mountain_shadcn from '../platform/mountain/shadcn'
import { phase } from '../6/4'
import { EIGHT_CURRICULUM_SCIENCES } from '../pair/enforcement/gates/computational'
import { chsh } from '../platform/mountain/vortex'
import { buildMatrix, matrixMemo } from '../research/heaven/compute'
...
import { blockchainFusion, tamperingCostDecoded } from '../platform/water/crypto'
import { societyFuture, societyRegulates } from '../research/earth/governance'
...
import { moviesNativeFormat, oneOpenGraphAll, taxonomyIcons } from '../research/fire/li'
import { ancientCalendars, ancientCalendarsDecodedAsAlgebraicTheoremsMappingTimeInTime } from '../applications/thunder/decode'
import { babelFold, textToMovie } from '../research/earth/world'
import { areaPairs, bothEarthsRotateWithinEachOther, cardinalPyramidTipsProvenByMath, doubleTorus3D, earthRealisedByComputingPolesAsPyramid, hexagramIsHexColorDuality, merkaba, uiConvertsFlatToThreeDQuantum } from '../platform/mountain/geometry'
...
import { holographicFractalArchitecture as holographicFractalArchitectureCore } from '../applications/thunder/movie/glass'
import { yinYang } from '../quantum/spirit'
import { scaleColor, A432_HUE, GOLDEN_ANGLE, movieCanvasHex } from '../quantum/science'
import { computedMovieThemeColors, FRACTAL_CLOCK_DIVISORS, fractalClockDur, fractalClockS } from '../research/fire/plasma/ball' // the ONE quantum clock — every declarative duration below is a divisor step of the 108 s hero cycle (animationsFractalOfOneClockDiscovered)
...
export { githubPermalink, SOURCE_REPO, revolutChannel, AUTHOR_HANDLE } from '../platform/wind/site' // bridge the proof-link helper + the Revolut monetisation/contact channel (site.ts reaches the barrel by a named list that omits new exports; ui.ts is in export*)
import { staticPages, homeHero } from '../platform/wind/site'
import { sealWholeDiamond } from '../research/fire/diamonds'
import { dimensionalMerkabaGraphRealtimeMetric } from '../applications/thunder/trading'
import { teslaPatentsResearchedInWaves } from '../research/fire/physics'
import { displayAllWithFewEntropySaved } from '../ledger'
import { warPaysTheForgerPrice } from '../research/earth/world'
...
import { rosettaRayOf } from '../platform/water/digit'
import { piHexDigitAt, nthPrimeAt } from '../7/3'
import { entangledWiringOf } from '../platform/wind/routes/corpus'
