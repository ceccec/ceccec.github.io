...
// The shared animation engine (src/0) drives the wave-tick loop; the component keeps its own
// play/pause (`running`) and the tempo interval — the engine owns only the per-frame tick.
