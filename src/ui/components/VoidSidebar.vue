...
// The shared animation engine (src/0): the re-rise is a single frame on each navigation — engine.tick().
const engine = createAnimationEngine(visualise)
...
watch([() => route.path, () => frontmatter.value], () => engine.tick())
</script>
