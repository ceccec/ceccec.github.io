...
const bgItem: Record<string, { label: string; tip: string }> = {
  'Double torus 3d 5d 8d': { label: 'Двоен торус 3d 5d 8d', tip: 'Повърхността от род 2, сгъваема през измеренията.' },
...
<template>
  <section class="md dt-card" :data-hexagram="ICHING_MASK.hexagram" :data-trigram="ICHING_MASK.glyph">
