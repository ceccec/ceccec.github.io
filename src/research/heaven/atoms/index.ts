...
import type { Atom, ConceptCommand, ConceptCommandName, DiamondFacet, DiamondKind, AnalogChannel, LocalAnswer, MindMatrix } from '../../../platform/wind/types'
...
import { areaPairs, dualTorusTrinities } from '../../../platform/mountain/geometry'
