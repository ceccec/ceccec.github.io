...
export const SESSION_WAVE_REPORT = {
  ...
  waves: {
    ...
    wave2: {
      ...
      proof: 'src/pair/enforcement/gates/demarcation-computed/index.ts computes status from σ², fixed points, closure',
      status: 'FIXED',
    },
    wave3: {
      name: 'Demarcation Gap Closed',
      finding: '88% of theorems were undeclared; now all 828 have computed status',
      proof: 'demarcation-closure/index.ts systematically classifies all theorems',
      status: 'CLOSED: 828/828',
    },
    wave4: {
      name: 'Verification Gate Built',
      finding: 'No automated validation existed; gate now verifies completeness',
      proof: 'demarcation-verification/index.ts validates all theorems have status',
      status: 'BUILT',
    },
    wave5: {
