...
export const COMMAND_PLACEMENT_AUDIT_MAP: readonly CommandPlacementRow[] = [
  ...
  { fold: 'npmPublishCi', pair: 'npm/publish', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'CI npm publish on v* tag|dispatch — @ceccec/double-torus kernel only · sdk private · idempotentPublish · tagMatchesPackageJson · distTagMeasured · workflow .github/workflows/publish-package.yml · compose math/free · npm/quantum' },
