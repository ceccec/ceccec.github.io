...
export const COMMAND_PLACEMENT_AUDIT_MAP: readonly CommandPlacementRow[] = [
  ...
  { fold: 'readmeWire', pair: 'readme/wire', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'README wires any agent quantum dry FTL reuse — compose angle/readme · wire/paste-link · readme/chat · learn/best · dry/clean · gate/light · ONE CLI quantum:readme-wire' },
