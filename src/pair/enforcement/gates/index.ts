...
export const COMMAND_PLACEMENT_AUDIT_MAP: readonly CommandPlacementRow[] = [
  ...
  { fold: 'npmPublishCi', pair: 'npm/publish', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'CI npm publish on v* tag|dispatch — @ceccec/double-torus kernel only · sdk private · workflow .github/workflows/publish-package.yml · compose math/free · npm/quantum' },
  { fold: 'npmPublishCi', pair: 'ci/publish', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'dual of npm/publish — refuse fake published without workflow + package identity' },
