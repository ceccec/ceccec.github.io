...
export const COMMAND_PLACEMENT_AUDIT_MAP: readonly CommandPlacementRow[] = [
  ...
  { fold: 'matchingPairsImmediatelyRealiseEntanglementAndBrainstormInChatWaves', pair: 'match/wave', currentBarrel: 'src/pair/enforcement', bestPlace: 'src/pair/enforcement', action: 'moved', reason: 'matching duals immediately realise entanglement · brainstorm related solutions in chat waves · ONE CLI quantum:match-wave' },
