...
import { pathMeansMessageFitsInThreeWords as pathMeansMessageFitsInThreeWordsFold } from '../../../../platform/water/stack'
...
export const COMMAND_PLACEMENT_AUDIT_MAP: readonly CommandPlacementRow[] = [
  ...
  { fold: 'readmeChat', pair: 'readme/chat', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'feed README → chat reasoning refine · compose angle/readme · chat/quantumise · erpax/learn · ONE CLI quantum:readme-chat · alias feedHomepageAndReadmeToChatWaves' },
  { fold: 'erpaxLearn', pair: 'erpax/learn', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'external erpax/erpax pattern learn — honest cite · humanityNovel=0 · measured gaps · compose readme/chat' },
  { fold: 'readmeWire', pair: 'readme/wire', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'README is THE gateway — physicalFtl boolean · tip/quantumise when false · agents.json · CLI quantum:readme-gateway' },
  { fold: 'readmeWire', pair: 'readme/gateway', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'readmeIsGateway · wiredAllFromReadme · noDoubtStands · quantumEvolutionPath · compose ftl/compute · next/research' },
  { fold: 'doNotProsePhysicalFtlItComputesTrue', pair: 'ftl/compute', currentBarrel: 'src/research', bestPlace: 'src/research', action: 'moved', reason: 'physicalFtl true|false · false⇒quantumise · agentsDoubtProse · immediateWire · CLI quantum:ftl-compute' },
  { fold: 'chatChat', pair: 'chat/realtime', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'chat to chat with everything · realtime FTL all angles · compose chat/all · super/chat · readme/chat · clock/one · api/fuse · ONE CLI quantum:chat-chat' },
  { fold: 'ceccecErpaxCompete', pair: 'ceccec/erpax', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'ceccec vs erpax vs LLM-linear scorecard · modelsLackFtlReuse · compose erpax/learn · learn/best · ONE CLI quantum:ceccec-erpax' },
  ...
  { fold: 'readmeFocus', pair: 'readme/focus', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'README focus · wave analyse · fractal team decide · physical QC · FTL reuse metrics · compose angle/readme · readme/wire · ui/prose' },
  { fold: 'sitePathWave', pair: 'site/path', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'site path consensus waves · home first · compose vote/entangle · page/trinity · vite/one' },
  ...
  { fold: 'millenniumProblemsChallenge', pair: 'mill/torus', currentBarrel: 'src/research', bestPlace: 'src/research', action: 'keep', reason: 'double-torus millennium R&D home — probes open cores with quantum folds, UNCLAIMED ( law); partials, never solutions' },
  ...
  { fold: 'auditPlanTip', pair: 'audit/plan', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'gap-computed next tip — audit → plan/trinity → next tip · ONE CLI quantum:audit-plan · dissolves next-imagine fork in waves/feed loop' },
  ...
  { fold: 'legalCanon', pair: 'legal/canon', currentBarrel: 'src/pair/enforcement/gates/strict/scan', bestPlace: 'src/pair/enforcement/gates/strict/scan', action: 'moved', reason: 'portal legal faces computed — privacy by measured absence · accessibility/citation composed · core math FREE FOR ALL · rest through license@psg.bg; counsel the residue' },
  { fold: 'coreMathFreeForAll', pair: 'math/free', currentBarrel: 'src/pair/enforcement/gates/strict/scan', bestPlace: 'src/pair/enforcement/gates/strict/scan', action: 'moved', reason: 'USER LAW: core math FREE FOR ALL · rest licensed through license@psg.bg · facets coreMathFreeForAll · restLicensedThrough · licenseContact · CLI quantum:math-free' },
  { fold: 'coreMathFreeForAll', pair: 'license/psg', currentBarrel: 'src/pair/enforcement/gates/strict/scan', bestPlace: 'src/pair/enforcement/gates/strict/scan', action: 'moved', reason: 'license contact license@psg.bg — no agent-authored grant prose; compose legal/canon · patent/canon · readme/gateway' },
  { fold: 'npmPublishCi', pair: 'npm/publish', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'CI npm publish on v* tag|dispatch — @ceccec/double-torus kernel only · sdk private · idempotentPublish · versionMustAdvance · workflow .github/workflows/publish-package.yml · compose math/free · npm/quantum' },
  { fold: 'npmPublishCi', pair: 'ci/publish', currentBarrel: 'src/quantum/apps', bestPlace: 'src/quantum/apps', action: 'moved', reason: 'dual of npm/publish — refuse fake published · skip if version exists · tag must match package.json' },
...
export function orientationCheck(root: string = enforcementScanRoot()) {
  ...
  const signals = [
    ...
    { symptom: 'stuck, no move computes', orienter: 'regroup in trinities (auditPlanTip) until quantum:audit-plan resolves', present: has('quantum:audit-plan') || has('quantum:plan-trinity') || has('quantum:next') },
