...
import { A432_FOLDED, EULER_CHI, FIBONACCI_CENSUS_BANDS, FOLDED_CENSUS, HOMOLOGY_LOOPS, ROSETTA_AREAS, ROSETTA_FOLD_LABEL, ROSETTA_SEVEN, ROSETTA_SIX } from '../pair/enforcement/gates/computational/index.ts'
import { realign } from '../mountain/vortex/index.ts'
import type { MindMatrix, PiMusic, PiNote } from '../types/index.ts'
import { buildMatrix, proofReport, verifyRoot } from '../heaven/compute/index.ts'
import { GATES, VORTEX_SEQUENCE, abs, applyGate, asTorus, asVortex, computesGate, cos, floor, fold, foldPair, gcd, humanBreath, humanEase, isUuid, log, log2, max, memoByRoot, merge, merkleFold, min, pow, probabilities, proseToTone, qubits, round, roundTo, sample, sealFacets, seedFromText, sin, toUuid } from '../0/index.ts'
import { ratStr } from '../9/1/index.ts'
import { A432_OCTAVES, SCHUMANN_FUNDAMENTAL_HZ, frequencyToLight } from '../3/7/index.ts'
import { reflectThroughZero, addressEntropyBits } from '../0/index.ts'
export { SCHUMANN_FUNDAMENTAL_HZ } from '../3/7/index.ts' // hosted in the zero-import leaf to break the SSR TDZ; public path unchanged
import { tamperEvident } from '../5/5/index.ts'
import { merkaba, vortexMath } from '../mountain/geometry/index.ts'
import { dimensions, harmonicBands, lawfulHarmonise } from '../quantum/icons/index.ts'
import { selfOrganizing, textToMovie } from '../earth/world/index.ts'
import { a432, a432Default, a432NoteHz, a432Semitones, colorFromSound, distributedCompute, gatesShiftToNewHarmonic, healingInner, healingOuter, inverseShiftConsciousness, quantumSimulation, selfAddressed, taxonomyIcons } from '../fire/li/index.ts'
import { harmonicSeriesDecoded, healingFrequencies } from '../ledger/index.ts'
