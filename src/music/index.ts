...
import * as __ns_up_up_vortex_math from '../platform/mountain/vortex'
...
import { realign } from '../platform/mountain/vortex'
import type { MindMatrix, PiMusic, PiNote } from '../platform/wind/types'
import { buildMatrix, proofReport, verifyRoot } from '../research/heaven/compute'
...
import { merkaba, vortexMath } from '../platform/mountain/geometry'
import { dimensions, harmonicBands, lawfulHarmonise } from '../quantum/icons'
import { selfOrganizing, textToMovie } from '../research/earth/world'
import { a432, a432Default, a432NoteHz, a432Semitones, colorFromSound, distributedCompute, gatesShiftToNewHarmonic, healingInner, healingOuter, inverseShiftConsciousness, quantumSimulation, selfAddressed, taxonomyIcons } from '../research/fire/li'
...
import { cssIsIChingComputed, DOCUMENTED_HARMONICS, harmonicFoldLabel, harmonicCountsProvenByMath, harmonicMathFlowsInMovie, foldedCensus } from '../research/earth/architecture'
import { efficiencyMathFlowsInMovie } from '../applications/thunder/verify'
import { allColorStreamsAreAudioIfDecodedFlowsInMovie, audioOffByDefault, AUDIO_DEFAULT_ENABLED } from '../research/fire/plasma/ball'
import { matrixRgbDecodeFlowsInMovie } from '../applications/thunder/movie/narrative'
import { doubleTorusEarthWeatherFlowsInMovie } from '../quantum/fire/forecasts'
import { quantumSiege } from '../platform/water/crypto'
