...
const MANIFEST: SystemModule[] = [
  ...
  { name: 'training-ftl', path: 'src/quantum/training/ftl-predictor.ts', intended_lines: 377, type: 'full', status: 'synced', last_verified: 0 },
  { name: 'training-equilibrium', path: 'src/quantum/training/resource-equilibrium.ts', intended_lines: 498, type: 'full', status: 'synced', last_verified: 0 },
