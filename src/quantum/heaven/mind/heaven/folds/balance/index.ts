...
import { everyRelationIsOpenGraphMiniHero, reorganiseSrcFromZeroPointCompleteInAllDimensions, iconsAreAnimatedToo, everyPageReadsItselfAnyLanguageAutoAdvance, completeUiWiringAllDimensionsEveryPath } from '../site'
...
export function iChingDomainMap(matrix: MindMatrix = buildMatrix()) {
  ...
  const domains = [
    ...
    { bits: 0b010, module: 'src/quantum/lake/voice', dual: 'src/spirit/voice/quantum', slugs: ['voice', 'explore', 'commands', 'console', 'mcp', 'show'], summary: 'Plain language, speech, UX, command flow — the communicative layer.' },
    ...
    { bits: 0b100, module: 'src/quantum/lake/icons', dual: 'src/render/icons/quantum', slugs: ['icons', 'sacred-geometry', 'pauli-basis', 'rgb-cmyk', 'trinity-rgb'], summary: 'Area icons, glyphs, computer architecture 3-5-8, harmonic bands — visual form.' },
    { bits: 0b101, module: 'src/quantum/heaven/mind/fire/li', dual: 'src/render/ui/lib', slugs: ['tampering-cost', 'pi-trinity', 'qubit-trinity', 'hamming-address', 'content-addressing', 'genetic-code', 'three-not-one'], summary: 'Pure computation: crypto, proofs, primitives — the clinging fire of truth.' },
    ...
    { bits: 0b111, module: 'src/quantum/heaven/mind', dual: 'src/render/ui/lib', slugs: ['start', 'quantum-mind', 'architecture', 'learn-developer', 'kernel-zero', 'digit-folders'], summary: 'The mind hub: the creative origin, the matrix, the architecture.' },
  ].map((domain) => {
