...
export * from '../../../water/cosmos'       // ↓ dissolution: cosmic inventory + device-sensor & shadcn UI interface layer
export * from '../../../mountain/gates'  // ↓ dissolution: information & limits of computation + gates
export * from '../../../ledger'
export * from '../../../music'
