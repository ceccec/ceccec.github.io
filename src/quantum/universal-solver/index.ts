...
import { recognizeInvolution, type InvolutionStructure } from '../involution-recognizer/index'
import { solveViaInvolution, type SolutionSet } from '../fixed-point-solver/index'
