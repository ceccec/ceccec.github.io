...
import type { Edge } from '../../../../platform/mountain/vortex'
...
import { weatherForecastQuantumComputedRealtime } from '../../../research/fire/forecasts'
...
import { dims, DIMENSIONS, DIMENSION_NAMES } from '../../../platform/mountain/dimensions'
...
export { tamperEvident } from '../../../5/5' // pi-train wave 8 tier-A
export { MAX_TAMPERING_COST_PRINCIPLE } from '../../../4/6' // pi-train wave 5 tier-A
...
export type { Edge } from '../../../../platform/mountain/vortex'
export { hopfieldStore, hopfieldRecall, hopfieldEnergy, bumpStep, bumpEvolve } from '../../../../platform/mountain/vortex'
export { codeRobustness } from '../../../../research/earth/life'
...
export { dims, DIMENSIONS, DIMENSION_NAMES } from '../../../platform/mountain/dimensions' // ten animation dimensions — the 6 cross-fold appearance axes + 4 genus-2 homology loops
...
import type {
  ...
  DiamondCompletenessReport } from '../../../../platform/wind/types'
export type * from '../../../../platform/wind/types'
...
import { atoms, conceptCommands, computePiDigits, PI_TRAIN_DIGITS, REQUIRED_DIAMOND_KINDS, REQUIRED_DIAMOND_POLES, REQUIRED_ANALOG_CHANNELS, SINGLE_WORD_METHODS } from '../../../../research/heaven/atoms'
export { atoms, conceptCommands } from '../../../../research/heaven/atoms'
export * from '../../../../research/heaven/atoms'
export { glagoliticHomeFromEnglish } from '../../../../research/fire/li' // the Glagolitic home (computed from English) — re-exported so the dist generators enter mind through its index
export * from '../../../../research/fire/li'
...
export * from '../../../../research/heaven/core'
export * from '../../../../research/heaven/site'
export * from '../../../../research/heaven/balance'
export * from '../../../../platform/water/cosmos'       // ↓ dissolution: cosmic inventory + device-sensor & shadcn UI interface layer
export * from '../../../../platform/mountain/gates'  // ↓ dissolution: information & limits of computation + gates
export * from '../../../ledger'
export * from '../../../music'
export * from '../../../../platform/wind/language'
export * from '../../../../research/fire/physics'
export * from '../../../../platform/mountain/geometry'
export * from '../../../../applications/thunder/waves'
export * from '../../../../research/earth/architecture'
export * from '../../../../platform/mountain/seals'
export * from '../../../../applications/thunder/commands'
export * from '../../../../platform/mountain/og'
export * from '../../../../research/earth/civilisation'
export * from '../../../../research/heaven/laws'
export * from '../../../../research/heaven/compute'
export * from '../../../../research/heaven/essence'
export * from '../../../media'
export * from '../../../../research/earth/life/birth'
export * from '../../../../research/earth/life'
export * from '../../../../research/earth/death'
export * from '../../../stats'
export * from '../../../../platform/water/digit'
export * from '../../../widgets'
export * from '../../../../platform/water/encryption'
export * from '../../../../platform/mountain/source'
export * from '../../../clean'
export * from '../../../../research/earth/nature'
export * from '../../../../applications/thunder/movie/canvas'
export * from '../../../../applications/thunder/movie/narrative'
export * from '../../../../applications/thunder/movie/movielib'
export * from '../../../../applications/thunder/movie/movievars'
export * from '../../../../platform/wind/fusion'
export * from '../../../../applications/thunder/verify'
export * from '../../../../platform/wind/routes/corpus'
export * from '../../../../platform/water/double'
export * from '../../../../applications/thunder/decode'
export {
  allAnswersInside,
  allComputed,
  ...
  fusionComputes,
  fusionMovieComputes,
  allFormsAreTenDimensionalOrPurged } from '../../../../platform/wind/fusion'
export { allPossibleDomains, allInAppropriatePathAndIndex } from '../../../../applications/thunder/decode'
export { allInInteractiveMovie } from '../../../../applications/thunder/movie/narrative'
export { allInMovieOfLife } from '../../../../research/fire/plasma/ball'
export { allMdSignedFromSource } from '../../../../platform/mountain/og'
export { allLogicMovedToSource } from '../../../../platform/mountain/source'
export { allIsMonographScientificPaper } from '../../../../platform/wind/routes/corpus'
export * from '../../../../research/fire/features'
export * from '../../../../platform/mountain/topology'
export * from '../../../ui'
export * from '../../../../research/earth/governance'
export * from '../../../../research/fire/diamonds'
export * from '../../../../platform/water/crypto'
export * from '../../../../applications/thunder/trading'
export * from '../../../../research/earth/world'
export * from '../../../learning'
export * from '../../../../platform/mountain/geometry'
export * from '../../../platform/water/cache'       // cache + SHA-256/quantum correction + session decodes & proofs (correction folded here, water domain)
