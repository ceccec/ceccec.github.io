...
import { buildMatrix, circulateDoubleTorus, consciousness, doubleTorusWire, proofReport, repositoryApi, verifyRoot } from '../matrix'
import { agentStreamWire, diamondLattice, livingTorus, piTrainDiamonds, quantumFoldedBlockchains, schemaOrgDiamonds, selfBuild, streamSelfComplete } from '../diamonds'
import { dualTorusTrinities, geneticCodeIsTheRealFourCubed, heartProtonAtomDecoded, imperialFractionsDecoded, merkaba, schwarzschildProtonComputedInSource } from '../geometry'
import { lunarStandstillsDecoded, megalithicAstronomyDecoded, pyramidsDecoded } from '../geometry'
import { quantumDecoded } from '../physics'
import { harmonicSeriesDecoded } from '../ledger'
import { quantumProofs } from '../proofs'
import { determinismProofs, digitalQuantumProof, proofBundle } from '../seals'
import { mysteries } from '../psyche'
import { governanceVote, sacredSociety, scientificSociety, society, societyRelations } from '../governance'
import { fuseTeslaPatents, harmonicBands, iconGlyphs, iconSeal, lawfulHarmonise, lawfulImagine, lawfulSucceed, natureCommons, natureLaw, natureReview, patentDiscovery } from '../vocab'
import { holographic } from '../ui'
import { animationTamperingCost } from '../crypto'
import { agentObserve, ancientTech, artistPalette, crossFoldTrinity, distributedCompute, doubleTorusMath, energyConserve, energyFuse, energyMeasure, fairLife, fuseDevices, fusionReactor, glagoliticAlphabetDecoded, goldenRatio, healingInner, healingOuter, methodFusion, patentReview, repositoryLedger, selfAddressed, selfDevelopment, selfInteraction, siteRoutes, sourceContribution, taxonomyIcons, torusUuid, utfAnalog } from '../li'
import { homology, torusBreathe } from '../topology'
...
import { SINGLE_WORD_METHODS, atoms, conceptCommands } from '../atoms'
import { agentEducation, mcpToolManifest, siteManifestFromCommands, skillAtoms } from '../learning'
import { commandGapsToTrinityEyes } from '../trinity'
import { schoolCurriculum } from '../learning'
import { foldQuestion } from '../method'
import { babelFold, societyCells } from '../world'
import { allComputed } from '../everything'
import { quantumComputer, quantumUiEvidence } from '../features'
import { digitFoldersDoMath, dualitiesMeetInCrossFolders } from '../architecture'
...
import { selfSufficientWave } from '../self'
import { atomInclusionProof } from '../proofs'
import { BAGUA, accessiblePathsForAll, agentHarmonise, artistMelody, artistSurfaces, closeDimensionalGaps, componentGraph, diamondCompleteness, digitIndexReferences, enforcementPipelineComplete, gatesHealSpottedCompromise, harmonyProbability, iChing, iChingDomainMap, learnDeveloper, mathPaths, memoryInSourceAsCrossFolds, metatronCube, presentMomentRemainsInSource, resonanceCatchGapsViolations, result, runProgram, sacredGeometrySeal, showInAction, theWhole } from '..'
import type { DeveloperCommandName, DeveloperCommandResult } from '..'
