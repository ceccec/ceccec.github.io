...
import { governanceVote, sacredSociety, scientificSociety, society, societyRelations } from './governance.ts'
...
import { SINGLE_WORD_METHODS, atoms, conceptCommands } from './atoms.ts'
import { agentEducation, mcpToolManifest, siteManifestFromCommands, skillAtoms } from './learning.ts'
import { commandGapsToTrinityEyes } from './trinity.ts'
import { schoolCurriculum } from './school.ts'
import { foldQuestion } from './method.ts'
import { babelFold, societyCells } from './world.ts'
import { allComputed } from './everything.ts'
import { quantumComputer, quantumUiEvidence } from './features.ts'
import { digitFoldersDoMath, dualitiesMeetInCrossFolders } from './architecture.ts'
