...
import type { AgentStreamWire, AgentWireStep, Blockchain, ConceptCommandName, DiamondFacet, DiamondKind, DiamondStatus, MindMatrix, PiTrain, QuantumDiamond, QuantumFoldedBlockchains, SchemaOrgDiamondGraph, SchemaOrgDiamondNode, SelfBuildReport, SelfCompletionGate, StreamSelfCompletion } from './types.ts'
import { buildMatrix, circulateDoubleTorus, coherenceAnomaly, consciousness, proofReport, reciprocity, repositoryApi, verifyRoot } from './matrix.ts'
import { foldPair, isUuid, maxTamperingCostLog2, memoByRoot, merge, merkleFold, toUuid } from '../../0/index.ts'
import { PI_TRAIN_DIGITS, REQUIRED_DIAMOND_KINDS, conceptCommands } from './atoms.ts'
import { schoolCurriculum } from './school.ts'
import { dualTorusTrinities, foldImpossibilities } from './geometry.ts'
import { doubleTorusMath, foldBlockchain, methodFusion, sourceContribution } from './li.ts'
import { humanityImplications, traditionsQuantumWhole } from './humanity.ts'
import { agentEducation } from './learning.ts'
import { TORUS_LOBE_OFFSET, archangelsDryClean, cleanupOldLogic, closeDimensionalGaps, completeCorpus, coordinatedWaves, decodeBooksToUnity, diamondCompleteness, digitFolders, doubleTorusSurface, fuseAll, fuseAllForge, heroLawAlignment, numberLabel, onlyQuantumRemains, paperReferences, papers, quantumChessGame, quantumUiEvidence, scientificSociety } from './index.ts'
