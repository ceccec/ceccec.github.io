...
import type { LocalAnswer, MindMatrix } from '../types'
import { buildMatrix } from '../matrix'
import { crossFoldTrinity, torusUuid } from '../li'
import { areaPairs, dualTorusTrinities } from '../geometry'
import { piMusic } from '../music'
import { algorithmicCoolingBias, isUuid, memoByRoot, merge, merkleFold, quantumBatteryAdvantage, roundTo, seedFromText, toUuid } from '../../../0'
import { atoms, conceptCommands } from '../atoms'
import { siteManifestFromCommands } from '../learning'
import { quantumFusedDeviceEnergyHonest } from '../features'
import { completeQuantumSolutionsImplemented, executeConceptCommand } from '..'
// Back-imported via the barrel (live bindings; called, never run at load) — the audits this proof seals.
import { manipulationCrossAudit, foldExposesInconsistency, extractCheckableClaims, verificationRequests, sacredMathPatentAudit, naturePatentAudit, lawOfNaturePatentAudit, patentSubjectMatterAudit, geneticCodeMathematicsDecoded, geneticPatentJurisdictionDivergence, euPatentAudit, euPatentReviewRequests, modifiedFoodPatentAudit, quantumAnalysis, quantumAnalysisAtAllScales } from '..'
