...
import type { AnalogChannel, DualTorusTrinities, MindMatrix, TrinityAxis, TrinityPair, TrinityPhase, TrinityStep } from '../types'
import { buildMatrix } from '../matrix'
import { VORTEX_SEQUENCE, digitalRoot, foldPair, gcd, groupOrbit, isUuid, memoByRoot, merge, merkleFold, modUnits, rat, ratAdd, ratEq, ratMul, ratStr, sealFacets, seedFromText, toUuid, vortexHarmonicRatios } from '../../../0'
import { REQUIRED_ANALOG_CHANNELS } from '../atoms'
import { taxonomyIcons, torusUuid } from '../li'
import { A432_HUE, GOLDEN_ANGLE, frequencyToLight, lobeHues } from '../vocab'
import { ICHING_NUMBERS, cssIsIChingComputed } from '../css'
