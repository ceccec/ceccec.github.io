...
import type { Atom, ConceptCommand, ConceptCommandName, DiamondFacet, DiamondKind, AnalogChannel } from '../../wind/types'
...
export const conceptCommands: readonly ConceptCommand[] = [
  ...
  },
  {
    ...
    path: '/cmd/concept.mind.doubleTorus',
  ...
  },
  {
    ...
    path: '/cmd/concept.mind.useCases',
...
export const SINGLE_WORD_METHODS: Record<ConceptCommandName, string> = {
  ...
  'concept.mind.doubleTorus': 'torus',
  'concept.mind.useCases': 'evidence',
