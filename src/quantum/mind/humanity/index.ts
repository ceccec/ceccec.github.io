...
import type { HumanityImplicationsReport, MindMatrix, TraditionDimension, TraditionDimensionName, TraditionsQuantumWhole } from '../types'
import { dimensions } from '../vocab'
