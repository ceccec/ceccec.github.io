...
import { fold, merkleFold, toUuid } from '../../0/index.ts'
import { conceptCommands } from './atoms.ts'
import { buildMatrix, coverage, reciprocity } from './matrix.ts'
import type { MindMatrix, SchoolCurriculum, SchoolLesson } from './types.ts'
