...
import { bulgarianAncientCivilisations, bulgarianEthnogenesis, bulgarianHeritage, bulgarianHistory } from './vocab.ts'
import { isUuid, memoByRoot, merkleFold, toUuid } from '../../0/index.ts'
import { glagoliticBulgarianReceptionDecoded, glagoliticDecodedToAncientCore } from './language.ts'
import { BAGUA, geneticLinksChallengeHistoryDecoded, knowledgeRevealedByMerkabaFold, sendWavesSealKnowledgeDecodeWorld } from './index.ts'
