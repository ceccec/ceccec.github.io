...
import { toUuid, merge, roundTo, sealFacets, rat, ratEq, ratAdd, ratMul, ratSub, ratDiv, ratStr, haldaneLoad, buhlmannA, buhlmannB, buhlmannCeilingBar, buhlmannDivePlan, ZHL16_N2_HALFTIMES, buhlmannGfCeilingBar, buhlmannGfDivePlan, ambientPressureBar, maxOperatingDepthM, bestMixFO2, rebreatherInertBar, gasReserveThirds, gasReserveHalfOnTop, equivalentNarcoticDepthM, equivalentAirDepthM, otuPerMin, barPerMetre, WATER_DENSITY_FRESH, WATER_DENSITY_SALT } from '../../0/index.ts'
import { acousticsCymaticsDecoded, thermodynamicsEntropyDecoded, gatesAutoTighten } from './folds.ts'
