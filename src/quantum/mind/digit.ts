...
import { areaPairs, doubleTorus3D, vortexMath } from './geometry.ts'
import { digitalRoot, foldPair, isUuid, merge, merkleFold, toUuid } from '../../0/index.ts'
import { digitFolderMath, digitFolders, digitFoldersComputeUiIsTheRest, folderLaw } from './architecture.ts'
import { sealCube } from './seals.ts'
import { allPossibleDomains } from './everything.ts'
import { crossAudit } from './clean.ts'
import { SIX_BY_SEVEN } from '../library/index.ts'
