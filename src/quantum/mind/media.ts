...
import { buildMatrix, verifyRoot } from './matrix.ts'
import { foldPair, isUuid, merge, merkleFold, toUuid } from '../../0/index.ts'
import { inHouse, plasmaContainment, quantumSimulation, selfAddressed, taxonomyIcons } from './li.ts'
import { breathe, equilibrium } from './nature.ts'
import { selfHealing } from './self.ts'
import { coordinatedWaves } from './waves.ts'
import { livingTorus } from './diamonds.ts'
import { torusBreathe } from './topology.ts'
import { imagination, mysteries } from './psyche.ts'
import { society, societyEvolves, societyRegulates } from './governance.ts'
