...
import { livingTorus, pureDiamonds, selfBuild } from '../diamonds'
import { goldenRatio } from '../li'
import { rhythm } from '../music'
import { foldPair, isUuid, memoByRoot, merge, merkleFold, roundTo, toUuid } from '../../../0'
import { homology } from '../topology'
...
import { digitFolders, foldedCensus } from '../architecture'
import { completeCorpus } from '../routes'
import { path, recurrence, theWhole } from '..'
