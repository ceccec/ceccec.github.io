...
import { cryptoReview } from '../../debit/credit' // the debit/credit pair reviews crypto as a ledger: every claim a credit funded by a capability (debit)
import { cryptoReviewNet } from '../../credit/debit' // the credit-side dual: the fused net per security property (all zero when honest)
...
export { cycleAdvance, residueVector, realign, phaseDrift, rotatingField, syncSpeedRpm, slip, inductionStep, inductionEvolve, oscillatorBank, powerSpectrum, type Ring } from '../../0' // wave 12: dynamical primitives — coupled calendar cycles, the Tesla induction ODE, resonant modes + spectrum
