...
import { areaPairs } from '../geometry'
import { atoms, conceptCommands } from '../atoms'
import { pureDiamonds, quantumFoldedBlockchains } from '../diamonds'
import { commandGapsToTrinityEyes, trinityEncryption, trinityGates } from '../trinity'
import { sealAll } from '../seals'
import { compactHeroReplacesSimple, freeAnimations } from '../ui'
import { professionals, quantumSitemap } from '../site'
import { harmonicBands, multidimensional, openGraph } from '../vocab'
import { completeCorpus, diamondRoutes, pageSkills } from '../routes'
...
import { blockchainFusion, quantumSiege } from '../crypto'
import { societyFuture, societyRegulates } from '../governance'
import { decode2020, decodeSymbols, numbersComputedNotAnchored } from '../decode'
import { worldEventsMap } from '../world'
import { foldedCensus } from '../architecture'
import { paperReferences, papers, papersReferencesDiamondsNoDrift } from '../academia'
