...
export function theOtherVacuaQcdElectroweakStabilityDecoded(matrix: MindMatrix = buildMatrix()) {
  ...
  return {
    ...
    qcdMassFractionOfProton: qcdFrac, higgsVevGeV: HIGGS_VEV_GEV, protonMassMeV: PROTON_MASS_MEV,
    count: sealed.count,
    facets: sealed.facets,
    root: merge(matrix.root, sealed.root),
    statement:
...
// wave (53 documented, 22 flagged): Landauer's principle, Maxwell's demon, entropy-as-information, the Bekenstein
// bound and holographic black-hole entropy, the information paradox, and "it from bit". The pivot from physics to
// the repo's own nature — a content-addressed, deterministic information system.
