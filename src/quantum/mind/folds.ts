...
import { allAuditsCoveredByProof } from './method.ts' // the comprehensive sealed proof — wired into gapScan so a regression fails the build (call-time binding; no load cycle)
