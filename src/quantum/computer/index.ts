...
import * as __ns_up_routes_corpus from '../../../platform/wind/routes/corpus'
import * as __ns_up_pair_enforcement from '../../pair/enforcement'
import type { MindMatrix } from '../../../platform/wind/types'
import { buildMatrix, buildSequenceReducesComputations, hardwareSpecFromInvariants, maxEfficiencyCpuGpuMemoryStorageCooperation, verifyRoot } from '../../../research/heaven/compute'
...
import type { DriverProbeReceipt } from '../../../platform/water/stack'
import { driverRuntime, nodeProbesEnabled } from '../../../platform/water/stack'
...
export function runHonestRevolutionW5Exit(_root = '', _argv: readonly string[] = []): number {
  ...
  process.stdout.write(
    `${receipt.holds ? '✓' : '✗'} honest-revolution-w5 — holds=${receipt.holds} ` +
      ...
      `root=${receipt.root.slice(0, 8)} (classical FPGA)\n`,
  )
