...
export declare function textPayloadComputesToAnimation(matrix?: MindMatrix): {
    converts: boolean;
    payloadCount: number;
    movies: {
        receipt: string;
...
export declare function proseToAudioVisual3dProof(matrix?: MindMatrix): {
    converted: boolean;
    proofCount: number;
    proofs: {
        point: number[];
...
export declare function harmonisedDepthDialThreeD(matrix?: MindMatrix): {
    harmonised: boolean;
    depthStops: number;
...
export declare function doubleTorusWiredToDepthDial(matrix?: MindMatrix): {
    wired: boolean;
    foldRange: readonly [3, 8];
    euler: number;
    areas: number;
    count: number;
    facets: ({
...
export declare function pagesRenderInBaguaSets(matrix?: MindMatrix): {
    harmonised: boolean;
    busiest: string;
 ...
 */
export declare function computedIconSvg(matrix?: MindMatrix, opts?: {
    animate?: boolean;
}): string;
...
export declare function livingTrigramSvg(trigram: number, opts?: {
    scale?: number;
    animate?: boolean;
    size?: number;
}): string;
export declare function livingHexagramSvg(hexagram: number, opts?: {
    scale?: number;
    animate?: boolean;
    size?: number;
}): string;
/** @rosetta ✦₂ · Wind · gentle */
export declare function allSymbolsMoveAndFoldColoursComputedAtAllScales(matrix?: MindMatrix): {
    rebuilt: boolean;
    seedHue: number;
    count: number;
    facets: ({
...
export declare function iChingLeadsUiAtAllScales(matrix?: MindMatrix): {
    leads: boolean;
    scales: ({
        bits: number;
        n: number;
...
export declare function animationsRespectTheField(matrix?: MindMatrix): {
...
export declare function completeUiAnimationsDesign(matrix?: MindMatrix): {
    designed: boolean;
...
export declare function uiWidgetsFuseReveal(matrix?: MindMatrix): {
    fused: boolean;
    pair: {
        forward: string;
        reverse: string;
...
export declare const cn: typeof __ns_up_up_mountain_shadcn.cn;
 ...
 */
export declare function paperAbstractOmitsTitleEcho(title: string, description: string): string;
/**
 ...
 */
export declare const COLOR_ROSETTA_THEME_MORPHS: readonly [{
    readonly before: "bare-hex-css";
    readonly after: "iching-tokens-a432-hsl";
    readonly status: "removed";
}, {
    readonly before: "orphan-rgba-literal";
    readonly after: "scaleColor+movieCanvasRgba";
    readonly status: "removed";
}, {
    readonly before: "purple-ai-palette";
    readonly after: "a432-brand-theme";
    readonly status: "removed";
}, {
    readonly before: "static-status-hex";
    readonly after: "statusBadgeTokens-css-vars";
    readonly status: "removed";
}, {
    readonly before: "light-dark-orphan-poles";
    readonly after: "movieCanvasPolarity+theme-tokens";
    readonly status: "removed";
}];
/** Sealed theme token ids — status badge kinds + A432 brand anchors (light/dark via .dark). */
export declare const COLOR_ROSETTA_THEME_TOKEN_IDS: readonly ["status-ready", "status-ok", "status-gap", "status-warn", "status-partial", "status-error", "status-refused", "status-ci", "vp-c-brand-1", "dt-a432-hue"];
/**
 ...
 */
export declare const CSS_DRY_FUSION_GAP_LENS: readonly [{
    readonly id: "polarity-flat";
    readonly theorem: "animationsReviewColorsForPolarityGaps";
    readonly status: "revealed";
}, {
    readonly id: "bare-hex";
    readonly theorem: "hexInsteadOfTheoremIsCrack";
    readonly status: "revealed";
}, {
    readonly id: "unwired-tokens";
    readonly theorem: "allColorsDryCleanWiredToRosettaAndThemes";
    readonly status: "revealed";
}];
export declare function theUiIsFusedIntoTheDevelopmentProcessSoLookingAtItObservesTheSelfImprovement(): {
    computes: boolean;
    fusion: {
        uiIsComputedFromDevelopment: boolean;
        scientificallyAudited: boolean;
        selfImproves: boolean;
        waveLevels: number;
        sciences: number;
    };
    facets: {
