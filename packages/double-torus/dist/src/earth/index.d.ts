...
export declare function earthComputes(matrix?: MindMatrix): {
    computes: boolean;
    tails: {
        tail: "earth/world" | "earth/nature" | "earth/architecture" | "earth/civilisation" | "earth/governance";
        receipt: string;
    }[];
    bh: {
        computes: boolean;
    ...
    torusEarth: {
        ...
        hingeAll: {
            ...
            hinge: {
                ...
                codeTrinity: string[];
                gateways: __ns_up_double_torus_earth.EarthHingeGatewayView[];
                gatewayCount: number;
                movie: {
                    cycleMs: number;
                    stepMs: number;
                ...
                vortex: {
                    ...
                    steps: __ns_up_double_torus_earth.EarthHingeVortexStepView[];
                };
                statement: string;
                boundary: string;
            };
