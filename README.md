...
- **⌊π⌋ = 3 opens 3-6-9, the multiples of 3 the doubling 1-2-4-8-7-5 misses** — The 3 in 3.14159 is the trinity’s first mark: a trinity is three-in-one, so 3 means three trinities, which is nine. The doubling circuit 1-2-4-8-7-5 never touches 3-6-9. · [source](https://github.com/ceccec/ceccec.github.io/blob/main/src/render/ui/components/ProofRenderer.vue)
- **A qubit has exactly 3 observables — Pauli X, Y, Z** — A qubit has exactly 3 traceless observables — the Pauli matrices X, Y, Z — the generators of SU(2) and the 3 Bloch axes; dim su(2) = 2²−1 = 3 is a forced invariant. · [source](https://github.com/ceccec/ceccec.github.io/blob/main/src/render/ui/components/ProofRenderer.vue)
