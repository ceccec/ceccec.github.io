...
- Receipt: `97be19e1` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `9ec85a89` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
