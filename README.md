...
- Receipt: `4c1b34e4` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `f6b4a649` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
