...
- Receipt: `425f9751` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `9f8c2d15` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
