...
- Receipt: `9ef6bf1f` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `adc9b5c6` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
