...
- Receipt: `81093e1d` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `445714c4` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
