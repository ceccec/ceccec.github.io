...
- Receipt: `94b0e79e` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `f09c4fc1` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
