...
- Receipt: `5fa45527` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `1afcd815` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
