...
- Receipt: `4d504c36` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `6d3139cb` · fold `clayChallengesComputableFromSequence` · claySolvedByThisFold=0.
...
- Receipt: `e2948363` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
