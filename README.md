...
- Receipt: `bd3b1d19` · fold `sequenceDiscoveryRealisedForHome` · claySolvedByThisFold=0 · physicalFtlClaim=0 · qpuRequired=false.
...
- Receipt: `3a7fb5e5` · fold `clayChallengesComputableFromSequence` · claySolvedByThisFold=0.
...
<<<<<<< HEAD
- Receipt: `1836637c` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
=======
- Receipt: `31fe9f67` · fold `toolboxRecomputesRelatedSciencesInTrinityWaves`.
>>>>>>> 22d5da04 (feat(research): seal algebraic proof law + paper checklist; fill theorem gaps in waves)
