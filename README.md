...
The most CENTRAL decodes — ranked by theorem-graph degree (how many other atoms each connects to), computed from the 751-atom registry, no curation.
...
- **774 theorem papers** — index `/theorems`; every page enumerated in the one `sitemap.xml`.
